...
%----------------CIRCOLARIZZO ORBITA-------------------------------------------
rPIniz = orbIniz(1) * (1 - orbIniz(2));  %raggio pericentro orbita iniziale

[orb2, dV2 , dT2] = manovraTangente(orbIniz, rPIniz, 'per');   %circolarizzo al pericentro
thetaMan1 = 0; %posizione prima manovra
...
%%
Title = 'STRATEGY 5c - Circolarization';
Maneuv_name=[{'initial point'};{'1st circularization'};{'1st tangent burn'};...
    {'Plane change & 2nd circularization'};{'2nd tangent burn'}; {'Final Point'}];
...
orbit3D(orbFin,2); 
%%
deltaV3 = dV2 + dV3 + deltaVReal + dV5 
deltaT3 = dT2 + dT3 + dT32 + dT4 + dT5 + tempoVolo(orb5, orb5(6), orbFin(6))
