...
elseif nman==2
    ...
    point1=deltaOmega/2+90; %rispetto a orbita iniziale
    
    point2t = 270; %rispetto a orb trasf
    
    pIniz = aIniz*(1-eIniz^2);
    rp1 = pIniz/(1+eIniz*cosd(point1)); %raggio in point1 nell'orbita iniziale
    ...
    error('numero di manovre selezionato non valido')
end
